...
export const metadata: Metadata = {
  title: "Career",
  description: "Join Nexora Technologies and build premium software products with a remote-first engineering team."
};
    ...
    <section className="py-20">
      <Container>
        ...
        <div className="mt-12 grid gap-5">
          {jobs.map((job) => (
            <article key={job.role} className="glass flex flex-col gap-5 rounded-2xl p-6 md:flex-row md:items-center md:justify-between">
              <div>
              ...
              <a href="mailto:careers@nexoratech.com" className="rounded-lg bg-cyanfire px-5 py-3 text-center font-bold text-ink transition hover:bg-mint">
                Apply Now
              </a>
            </article>
          ))}
